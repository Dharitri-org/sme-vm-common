...
func TestDCTGlobalSettingsPause_ProcessBuiltInFunction(t *testing.T) {
	...
	pauseKey := []byte(core.DharitriProtectedKeyPrefix + core.DCTKeyIdentifier + string(key))
...
func TestDCTGlobalSettingsLimitedTransfer_ProcessBuiltInFunction(t *testing.T) {
	...
	tokenID := []byte(core.DharitriProtectedKeyPrefix + core.DCTKeyIdentifier + string(key))
